...
!function (e, t, n) {
    ...
    !function () {
            ...
            var h = s.startSymbol(), f = s.endSymbol(), g = "{{" === h && "}}" === f, b = function (e, n, o) {
                ...
                dom: {}, now: e.performance ? t.bind(e.performance, e.performance.now) : Date.now || function () {
                    ...
                    function r(e) {
                        ...
                        e = t.element(e || d)[0];
                        var i = 50, a = t.element('<div class="md-scroll-mask">  <div class="md-scroll-mask-bar"></div></div>').css("z-index", i);
        ...
        function e(e, n, o, r) {
            ...
            function d(e, t) {
                var n = c(e) || "", o = n.indexOf(r.startSymbol()) > -1;
                o ? a(e, t, function () {
                    return c(e)
                }) : i(e, t, n)
            }
            ...
            return {expect: i, expectAsync: a, expectWithText: d}
        }
        ...
        !function () {
            function e(e) {
                ...
                var c = /^((?:x|data)[\:\-_])/i, s = /([\:\-\_]+(.))/g, l = ["", "xs", "gt-xs", "sm", "gt-sm", "md", "gt-md", "lg", "gt-lg", "xl", "print"], m = ["layout", "flex", "flex-order", "flex-offset", "layout-align"], u = ["show", "hide", "layout-padding", "layout-margin"];
            ...
            var f, g, b, E = /(-gt)?-(sm|md|lg|print)/g, v = /\s+/g, M = ["grow", "initial", "auto", "none", "noshrink", "nogrow"], $ = ["row", "column"], y = ["", "start", "center", "end", "stretch", "space-around", "space-between"], C = ["", "start", "center", "end", "stretch"], A = {
                enabled: !0,
                breakpoints: []
            };
        ...
        function a(e) {
            ...
            if (r && 0 !== i.length) {
                ...
                $.forEach(function (e) {
                    ...
                    for (var t, n = (e.match(c), 0); t = $[n]; n++)if (e.indexOf(".md-" + t) > -1)return x[t] += e;
                    for (n = 0; t = $[n]; n++)if (e.indexOf(t) > -1)return x[t] += e;
                    return x[y] += e
        ...
        function d(e, t) {
            var n = u[e], o = document.head, r = o ? o.firstElementChild : null;
        ...
        var T = ["50", "100", "200", "300", "400", "500", "600", "700", "800", "900", "A100", "A200", "A400", "A700"], w = !1, k = null;
        ...
        function e(e, n, o, r) {
            ...
            function d(a, d, c) {
                ...
                }), t.isDefined(c.mdNoFocusStyle) || (a.mouseActive = !1, d.on("mousedown", function () {
            ...
            function d(d, s) {
                return s.type = "checkbox", s.tabindex = s.tabindex || "0", d.attr("role", s.type), d.on("click", function (e) {
                    ...
                    function p(e) {
                        ...
                        (t === o.KEY_CODE.SPACE || t === o.KEY_CODE.ENTER) && (e.preventDefault(),
                        s.hasClass("md-focused") || s.addClass("md-focused"), h(e))
                    }
        ...
        !function () {
            t.module("material.components.datepicker").factory("$$mdDateUtil", function () {
                ...
                function E(e, t, n) {
                    var o = b(e), r = f(t) ? b(t) : null, i = f(n) ? b(n) : null;
                    return (!r || o >= r) && (!i || i >= o)
                }
        ...
        function o(e) {
            function o(e, t, n) {
                return {
                    ...
                    controller: function () {
                        this.hide = function () {
                            e.hide("prompt" === this.$type ? this.result : !0)
                        }, this.abort = function () {
                            e.cancel()
                        }, this.keypress = function (t) {
                            t.keyCode === n.KEY_CODE.ENTER && e.hide(this.result)
                        }
                    },
                    controllerAs: "dialog",
                    bindToController: !0,
            ...
            function r(e, o, r, d, c, s, l, m, u, p) {
                ...
                function M(e, t) {
                    var n = "alert" === t.$type ? "alertdialog" : "dialog", d = e.find("md-dialog-content"), c = "dialogContent_" + e.attr("id") || "dialogContent_" + r.nextUid();
                    e.attr({
                        role: n,
                        tabIndex: "-1"
            ...
            var i, a;
            return o.$inject = ["$mdDialog", "$mdTheming", "$mdConstant"], r.$inject = ["$mdDialog", "$mdAria", "$mdUtil", "$mdConstant", "$animate", "$document", "$window", "$rootElement", "$log", "$injector"], e("$mdDialog").setDefaults({
        ...
        function n(e, t) {
            function n(t, n) {
                e(n);
                var o = n.find("md-icon"), i = o.length ? o : n[0].getElementsByClassName("md-icon");
                if (1 == i.length) {
                    var a = i[0].nextElementSibling, d = i[0].previousElementSibling;
                    n.addClass(a && -1 != r.indexOf(a.tagName) ? "md-icon-left" : d && -1 != r.indexOf(d.tagName) ? "md-icon-right" : "")
                } else 2 == i.length && n.addClass("md-icon-left md-icon-right")
            }
            ...
            var r = ["INPUT", "TEXTAREA", "MD-SELECT"];
        ...
        function r(e, n, o) {
            function r(r, i, a, d) {
                ...
                var m = d[0], u = !!d[1], p = d[1] || e.fakeNgModel(), h = t.isDefined(a.readonly), f = t.isDefined(a.required), g = t.isDefined(a.mdNoAsterisk);
                if (m) {
                    if (m.input)throw new Error("<md-input-container> can only have *one* <input>, <textarea> or <md-select> child element!");
                    m.input = i;
                    var b = t.element('<div class="md-errors-spacer">');
                    i.parent().append(b), m.label ? f && !g && m.label.addClass("md-required") : o.expect(i, "aria-label", i.attr("placeholder")), i.addClass("md-input"), i.attr("id") || i.attr("id", "input_" + e.nextUid()), "textarea" === i[0].tagName.toLowerCase() && l(), u || s();
                    var E = m.isErrorGetter || function () {
                            return p.$invalid && (p.$touched || v())
                        }, v = function () {
                        var n = e.getClosest(i, "form"), o = n ? t.element(n).controller("form") : null;
                        return o ? o.$submitted : !1
                    };
                    r.$watch(E, m.setInvalid), p.$parsers.push(c), p.$formatters.push(c), i.on("input", s), h || i.on("focus", function (e) {
                        m.setFocused(!0)
                    }).on("blur", function (e) {
                        m.setFocused(!1), s()
        ...
        function d() {
            function e(e, t, n) {
                ...
                ("INPUT" === t[0].nodeName || "TEXTAREA" === t[0].nodeName) && (t.on("focus", o), e.$on("$destroy", function () {
                    t.off("focus", o)
                }))
            }
        ...
        function l(e, t) {
            return {
                addClass: function (n, o, r) {
                    var i = E(n);
                    "md-input-invalid" == o && i.hasClass("md-auto-hide") ? p(n, t, e)["finally"](r) : r()
                }
            }
        }
        ...
        function u(e) {
            return {
                enter: function (t, n) {
                    var o = E(t);
                    return o.hasClass("md-auto-hide") ? void n() : f(t, e)
                }, leave: function (t, n) {
                    return g(t, e)
                }
            }
        ...
        function h(e, n, o) {
            var r, i = [], a = E(e);
            return t.forEach(a.children(), function (e) {
                r = g(t.element(e), n), i.push(r.start())
            }), o.all(i)
        }
        ...
        function E(e) {
            var n = b(e), o = "ng-messages,data-ng-messages,x-ng-messages,[ng-messages],[data-ng-messages],[x-ng-messages]";
        ...
        var v = ["ngIf", "ngShow", "ngHide", "ngSwitchWhen", "ngSwitchDefault"];
        s.$inject = ["$mdUtil"], l.$inject = ["$q", "$animateCss"], m.$inject = ["$q", "$animateCss"], u.$inject = ["$animateCss"]
    }(), function () {
        function e(e) {
            return {
        ...
        function n(e, n, o, r) {
            ...
            return {
                restrict: "E", controller: "MdListController", compile: function (a, d) {
                    ...
                    function s(e) {
                        var n;
                        if ("div" == e)n = t.element('<div class="md-no-style md-list-item-inner">'), n.append(a.contents()), a.addClass("md-proxy-focus"); else {
                            n = t.element('<div class="md-button md-no-style"><div class="md-list-item-inner"></div></div>');
                            var o = t.element('<md-button class="md-no-style" md-no-focus-style></md-button>');
                            o[0].setAttribute("aria-label", a[0].textContent), u(a[0], o[0]), n.prepend(o), n.children().eq(1).append(a.contents()), a.addClass("md-button-wrap")
                        }
                        a[0].setAttribute("tabindex", "-1"), a.append(n)
                    }

                    function l() {
                        if (1 === E.length)m(E[0], a); else if (E.length > 1) {
                    ...
                    function m(n, o, r) {
                        if (n && !h(n) && n.hasAttribute("ng-click")) {
                            ...
                            var i;
                            i = r ? t.element('<md-button class="md-icon-button">') : t.element('<md-button class="md-secondary-container md-icon-button">'), u(n, i[0]), n.setAttribute("tabindex", "-1"), n.classList.remove("md-secondary"), i.append(n), n = i[0]
                        }
                        n && (n.hasAttribute("ng-click") || d.ngClick && p(n)) && (r && n.classList.remove("md-secondary"), a.addClass("md-with-secondary"), o.append(n))
                    }
                    ...
                    var g, b, E = a[0].querySelectorAll(".md-secondary");
                    if (a[0].setAttribute("role", "listitem"), d.ngClick || d.ngHref || d.href || d.uiSref || d.ngAttrUiSref)s("button"); else {
                        for (var v, M = 0; v = i[M]; ++M)if (b = a[0].querySelector(v)) {
                            g = !0;
                            break
                        }
                        g ? s("div") : a[0].querySelector("md-button:not(.md-secondary):not(.md-exclude)") || a.addClass("md-no-proxy")
                    }
                    return l(), c(), f
                }
            }
        ...
        function e(e, o, r, i, a, d) {
            function c(a, c) {
                ...
                return p = o.supplant(p, [u, a.html()]), a.empty().append(s), a.append(p), c.tabindex = c.tabindex || "0", function (a, c, s, l) {
                    ...
                    function f() {
                        if (x = t.element(c[0].querySelector(".md-select-menu-container")), N = a, s.mdContainerClass) {
                            var e = x[0].getAttribute("class") + " " + s.mdContainerClass;
                    ...
                    A && t.isDefined(s.multiple) && o.nextTick(function () {
                        var e = C.$modelValue || C.$viewValue;
                        e && A.$setPristine()
                    });
                    var S = C.$render;
                    C.$render = function () {
                ...
                l.optNodeForKeyboardSearch = function (e) {
                    ...
                    if (n.length) {
                        ...
                        return "html" == t ? r = function (e) {
                            var t = e.innerHTML, n = e.querySelector(".md-ripple-container");
        ...
        function a(e) {
            function o(e, o, s, l, m, u, p, h, f) {
                function g(e, t, n) {
                    function o() {
                        return p(t, {addClass: "md-leave"}).start()
                    }
                ...
                function b(r, i, a) {
                    function d(e, t, n) {
                        return n.parent.append(t), m(function (e, n) {
                            try {
                                p(t, {removeClass: "md-leave", duration: 0}).start().then(c).then(e)
                            } catch (o) {
                                n(o)
                            }
                        })
                    ...
                    function g(e, t, n) {
                        return n.disableParentScroll && !s.getClosest(n.target, "MD-DIALOG") ? n.restoreScroll = s.disableScrollAround(n.element, n.parent) : n.disableParentScroll = !1, n.hasBackdrop && (n.backdrop = s.createBackdrop(e, "md-select-backdrop md-click-catcher"), h.enter(n.backdrop, f[0].body, null, {duration: 0})), function () {
                    ...
                    function A() {
                        ...
                        function d(e) {
                            var t, o = s.nodesToArray(a.optionNodes), r = o.indexOf(a.focusedNode);
                ...
                function v(e, n, o) {
                    var m, u = n[0], p = o.target[0].children[0], h = f[0].body, g = o.selectEl[0], b = o.contentEl[0], E = h.getBoundingClientRect(), v = p.getBoundingClientRect(), M = !1, $ = {
                        left: E.left + d,
                        top: d,
                        bottom: E.height - d,
                    ...
                    }, C = E.width - 2 * d, A = g.querySelector("md-option[selected]"), T = g.getElementsByTagName("md-option"), w = g.getElementsByTagName("md-optgroup"), k = c(n, b), x = r(o.loadingAsync);
                    ...
                    var _ = g.getBoundingClientRect(), H = a(m);
                    if (m) {
                    ...
                    var I, O, R, L;
                    M ? (I = v.left, O = v.top + v.height, R = "50% 0", O + _.height > $.bottom && (O = v.top - _.height, R = "50% 100%")) : (I = v.left + H.left - H.paddingLeft + 2, O = Math.floor(v.top + v.height / 2 - H.height / 2 - H.top + b.scrollTop) + 2, R = H.left + v.width / 2 + "px " + (H.top + H.height / 2 - b.scrollTop) + "px 0px", L = Math.min(v.width + H.paddingLeft + H.paddingRight, C));
                    var F = u.getBoundingClientRect(), P = Math.round(100 * Math.min(v.width / _.width, 1)) / 100, B = Math.round(100 * Math.min(v.height / _.height, 1)) / 100;
                    return {
                        container: {
                            element: t.element(u),
                            styles: {
                                left: Math.floor(i($.left, I, $.right - F.width)),
                                top: Math.floor(i($.top, O, $.bottom - F.height)),
                                "min-width": L
                            }
                        },
                        dropDown: {
                            ...
                            styles: {
                                transformOrigin: R,
                                transform: o.alreadyOpen ? "" : s.supplant("scale({0},{1})", [P, B])
                            }
                        }
                    }
                }

                var M = "$mdSelect.show() expected a target element in options.target but got '{0}'!", $ = s.dom.animator;
                return {parent: "body", themable: !0, onShow: b, onRemove: g, hasBackdrop: !0, disableParentScroll: !0}
            }
        ...
        function e(e, n, o, r, i, a, d, c, s) {
            function l(e, t) {
                return t.tabindex || e.attr("tabindex", 0), e.attr("role", "slider"), o.expect(e, "aria-label"), m
            }
            ...
            function m(o, l, m, u) {
                ...
                function N(e) {
                    P() || (te = !0, e.stopPropagation(), l.addClass("md-dragging"), S(e))
                }
                ...
                var B = t.element(l[0].querySelector(".md-thumb")), U = t.element(l[0].querySelector(".md-thumb-text")), z = B.parent(), q = t.element(l[0].querySelector(".md-track-container")), j = t.element(l[0].querySelector(".md-track-fill")), V = t.element(l[0].querySelector(".md-track-ticks")), W = r.throttle(v, 5e3);
                ...
                var G, X, Q, Z, J, ee = {};
                v();
                var te = !1, ne = t.isDefined(m.mdDiscrete)
            }
            ...
            function o(e, n, o, i) {
                function a(t, a, d) {
                    ...
                    return a = o.extractElementByName(a, "md-toast", !0), d.onSwipe = function (e, t) {
                        ...
                        "down" === i && -1 != d.position.indexOf("top") && !l || "up" === i && (-1 != d.position.indexOf("bottom") || l) || ("left" !== i && "right" !== i || !l) && (a.addClass("md-" + r),
                            o.nextTick(n.cancel))
        ...
        o.$inject = ["$$rAF", "$mdUtil", "$parse", "$rootScope", "$window", "$scope", "$element", "$attrs"], o.prototype.register = function (e) {
            ...
            var t = this.getDimensionName_(), n = this.isHorizontal() ? "height" : "width";
            ...
            if (!(e === this.scrollOffset || e > this.scrollSize - this.size)) {
                var t = this.repeater.getItemSize();
                if (t) {
                    var n = Math.max(0, Math.floor(e / t) - c), o = (this.isHorizontal() ? "translateX(" : "translateY(") + n * t + "px)";
        ...
        function e(e, o, d, c, s, l, m, u, p, h) {
            ...
            function ee(n) {
                function o(t) {
                    t && (t = h.when(t), q(!0), be = !0, d.nextTick(function () {
                ...
                function r(t) {
                    ue[a] = t, (n || "") === (e.searchText || "") && (ce.matches = t, ce.hidden = j(), e.selectOnMatch && de(), te(), g())
                }

                var i = e.$parent.$eval(le), a = n.toLowerCase(), c = t.isArray(i);
                c ? r(i) : o(i)
            }
            ...
            function ie() {
                ...
                return ce.hasNotFound && !W() && (!ce.loading || be) && e >= P() && (fe || pe) && !Y()
            }
            ...
            function de() {
                ...
                1 === n.length && B(o).then(function (n) {
                    var o = t == n;
                    e.matchInsensitive && !o && (o = t.toLowerCase() == n.toLowerCase()), o && Z(0)
                })
            }

            var ce = this, se = e.itemsExpr.split(/ in /i), le = se[1], me = null, ue = {}, pe = !1, he = [], fe = !1, ge = 0, be = !1;
        ...
        function e() {
            return {
                ...
                link: function (e, t, n, o) {
                    o.hasNotFound = t.hasNotFoundTemplate, delete t.hasNotFoundTemplate
                },
        ...
        function e(e, n, o) {
            function r(r, i) {
                var d = null, c = null, s = o.mdHighlightFlags || "", l = e.$watch(function (e) {
                    ...
                    (null === d || e.unsafeText !== o.unsafeText) && (d = t.element("<div>").text(e.unsafeText).html()),
                    (null === c || e.term !== o.term) && (c = a(e.term, s)), n.html(d.replace(c, '<span class="highlight">$&</span>'))
                }, !0);
                n.on("$destroy", l)
            }
        ...
        t.module("material.components.chips").controller("MdChipsCtrl", e), e.$inject = ["$scope", "$mdConstant", "$log", "$element", "$timeout"], e.prototype.inputKeydown = function (e) {
            ...
            if (!(this.hasAutocomplete && e.isDefaultPrevented && e.isDefaultPrevented())) {
                ...
                if ((!this.separatorKeys || this.separatorKeys.length < 1) && (this.separatorKeys = [this.$mdConstant.KEY_CODE.ENTER]), -1 !== this.separatorKeys.indexOf(e.keyCode)) {
                    ...
                    if (e.preventDefault(), this.items.length >= this.maxChips)return;
                    this.appendChip(t), this.resetChipBuffer()
                }
            }
        ...
        }, e.prototype.hasMaxChips = function () {
        ...
        function e(e, o, r, i, a, d, c, s, l, m) {
            ...
            function j() {
                ...
                return t.forEach(P().dummies, function (t) {
                    e -= t.offsetWidth
                }), 0 > e
            }
            ...
            function K() {
                var e = 1;
                t.forEach(P().dummies, function (t) {
                    e += Math.ceil(t.getBoundingClientRect().width)
            ...
            var ce = this, se = !1, le = P(), me = [], ue = !1, pe = !1;
